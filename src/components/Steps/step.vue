    ...
    <div
      ...
      isCenter && !isVertical && !isSimple && 'is-center'
        ...
        <div
            ...
            >
                <div class="ellipsis-l1 lineTitle-step">{{lineTitle}}</div>
                <i class="el-step__line-inner" :style="lineStyle"></i>

            </div>

            <div class="el-step__icon" :class="`is-${icon ? 'icon' : 'text'}`" style="position: relative">
                <slot
                ...
                <div class="iconfont-step">
                    <i class="icon iconfont iconcheliangweiguibaojing"></i>
                </div>
            </div>
        </div>
        <!-- title & description -->
