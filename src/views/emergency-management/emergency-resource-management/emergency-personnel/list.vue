...
<template>
    <div class="app-container">
            ...
            <el-main style="padding: 20px 20px 0 20px">
                    ...
                    <el-form :inline="true" :model="form" ref="form" class="form-inline-search" label-width="120px">
                        <el-row :gutter="20">
                            <el-col :span="this.isSmallBtn ? 12 : 8">
                                <el-form-item label="姓名：" prop="name" class="form-inline-search-item">
                                    <el-input v-model="form.name" placeholder="请输入姓名"></el-input>
                                </el-form-item>
                            </el-col>

                            <el-col :span="this.isSmallBtn ? 12 : 8">
                                <el-form-item label="所属机构：" prop="unit" class="form-inline-search-item">
                                    <el-input v-model="form.unit" placeholder="请输入所属机构名称"></el-input>
                                </el-form-item>
                            </el-col>
                ...
                <el-card class="table-card">
                    <div style="margin-bottom: 10px">
                        <el-button type="primary" icon="el-icon-document-add" @click="addEmergency('add')">新增</el-button>
                    ...
                    >
                        ...
                        <el-table-column label="所属机构" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.unit}}</template>
                        </el-table-column>
                        <el-table-column label="职务" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.duty}}</template>
                        </el-table-column>
                        <el-table-column label="办公电话" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.tel}}</template>
                        </el-table-column>
                        <el-table-column label="移动电话" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.mobile}}</template>
                        </el-table-column>
                        <el-table-column label="学历" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.education}}</template>
                        </el-table-column>
                        <el-table-column label="专业" header-align="center" align="center">
        ...
        <div class="emergency-map-container">
            ...
            <div class="emergency-info">
                ...
                <div style="padding-left: 10px"  v-if="!(JSON.stringify(detailInfo) == '{}' || !detailInfo)" >
                    <el-row>
                        <el-col :span="12">
                            姓名：{{detailInfo.hasOwnProperty('name') ? detailInfo.name:''}}
                        </el-col>
                        <el-col :span="12">
                            职务：{{detailInfo.hasOwnProperty('duty') ? detailInfo.duty:''}}
                        </el-col>
                    </el-row>
                    <el-row>
                        <!--<el-col :span="12">
                            应急队伍归属：{{detailInfo.hasOwnProperty('unit')?detailInfo.unit:''}}
                        </el-col>-->
                        <el-col :span="12">
                            专业：{{detailInfo.hasOwnProperty('major')?detailInfo.major:''}}
                        </el-col>
                        <el-col :span="12">
                            办公电话：{{detailInfo.hasOwnProperty('tel') ? detailInfo.tel:''}}
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            所属应急机构：{{detailInfo.hasOwnProperty('unit')?detailInfo.unit:''}}
                        </el-col>
                        <el-col :span="12">
                            移动电话：{{detailInfo.hasOwnProperty('mobile')?detailInfo.mobile:''}}
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            生日：{{detailInfo.hasOwnProperty('birthday')?detailInfo.birthday:''}}
                        </el-col>
                        <el-col :span="12">
                            学历：{{detailInfo.hasOwnProperty('education')?detailInfo.education:''}}
                        </el-col>
                    </el-row>
                    <!--<el-row>
                        <el-col :span="12">
                            专业：{{detailInfo.hasOwnProperty('name')?detailInfo.name:''}}
                        </el-col>
                    </el-row>-->
                </div>
            </div>
        ...
        >
            <add-emergency-personnel :type="'add'" :companyInfo=companyInfo :detailInfo="detailInfo" v-on:toggleHidden="toggleHidden" ></add-emergency-personnel>
        </el-dialog>
        <!--新增的dialog-->
        <el-dialog title="编辑" :visible.sync="editShow" v-if="editShow"  width="950px"
                   :close-on-click-modal="false" append-to-body @close="closeDialog">
            <add-emergency-personnel :type="'edit'" :companyInfo=companyInfo :detailInfo="detailInfo" v-on:toggleHidden="toggleHidden" ></add-emergency-personnel>
            <!--<edit-emergency-personnel></edit-emergency-personnel>-->
        </el-dialog>
...
<script>
    ...
    import AddEmergencyPersonnel from './components/add-emergency-personnel.vue'
    import EditEmergencyPersonnel from './components/edit-emergency-personnel.vue'
    import elDragDialog from '@/directive/el-drag-dialog'

    import {fetchAreaTree} from '@/api/courseMonitor/alarmSynthesis';
    import {fetchEmergencyPersonPage,delEmergencyPerson} from '@/api/emergencyManagement/emergencyResource'
    ...
    export default {
        ...
        components: {Pagination, CommonSubtitle, googleMapView,AddEmergencyPersonnel,EditEmergencyPersonnel,elDragDialog,ToggleGoogleMap},
...
//                this.addRouteLine();
            ...
            getList(){
                ...
                fetchEmergencyPersonPage(obj).then(res => {
            ...
            delEmergency() {
                ...
                if (JSON.stringify(this.detailInfo) == '{}' || !this.detailInfo) {
                    this.$message({
                        message: '请选择需要删除的应急人员',
                        type: 'warning'
                    });
                    return
                }
                this.$confirm('此操作将删除该应急人员, 是否继续?', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    delEmergencyPerson({id:this.detailInfo.hasOwnProperty('id') ? this.detailInfo.id : null}).then(res => {
                        self.$message({
                            showClose: true,
                            message: '删除成功！',
                            type: 'success'
