                    ...
                    <el-row :gutter="20" >
                        <el-col :span="8">
                            <el-form-item label="联系人姓名:" prop="contact">
                                <el-input v-model="item.contact" placeholder="请填写联系人姓名" :disabled="isDisabled"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="联系人电话:" prop="contactTel">
                                <el-input v-model="item.contactTel" placeholder="请填写联系人电话" :disabled="isDisabled"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="联系人邮箱:" prop="email">
                                <el-input v-model="item.email" placeholder="请填写联系人邮箱" :disabled="isDisabled"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </div>
