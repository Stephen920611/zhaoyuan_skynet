    ...
    <div class="app-container">
        <el-container>
            <el-aside width="350px" class="search-tree all-background" style="overflow: hidden;">
                <CommonSubtitle title="应急队伍资源列表" :isBold="true"
            ...
            <el-main style="padding: 20px 20px 0 20px">
                    ...
                    <el-form :inline="true" :model="form" ref="form" class="form-inline-search" label-width="120px">
                        <el-row :gutter="20">
                            <el-col :span="this.isSmallBtn ? 12 : 8">
                                <el-form-item label="应急队伍名称：" class="form-inline-search-item">
                                    <el-input v-model="form.name" placeholder="请输入应急队伍名称"></el-input>
                                </el-form-item>
                            </el-col>
                ...
                <el-card class="table-card">
                    ...
                    >
                        ...
                        <el-table-column label="队伍名称" header-align="center" align="center" min-width="150">
                        ...
                        <el-table-column label="救援方向" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.direction}}</template>
                        </el-table-column>
                        <el-table-column label="负责人" header-align="center" align="center" min-width="50">
                            <template slot-scope="{row}">{{row.liablePerson}}</template>
                        </el-table-column>
                        <el-table-column label="负责人联系电话" header-align="center" align="center"  min-width="60">
                            <template slot-scope="{row}">{{row.tel}}</template>
                        </el-table-column>
                        <el-table-column label="值班电话" header-align="center" align="center"  min-width="60">
                            <template slot-scope="{row}">{{row.dutyTel}}</template>
                        </el-table-column>
        ...
        <div class="emergency-map-container">
            ...
            <div class="emergency-info">
               ...
               <!-- <div style="padding-left: 10px">
                    <el-row>
                        <el-col :span="12">
                            储备点名称：{{detailInfo.name}}
                        </el-col>
                        <el-col :span="12">
                            负责人姓名：{{detailInfo.name}}
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            应急队伍归属：{{detailInfo.name}}
                        </el-col>
                        <el-col :span="12">
                            负责人联系电话：{{detailInfo.id}}
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            所属单位名称：{{detailInfo.des}}
                        </el-col>
                        <el-col :span="12">
                            备注：{{detailInfo.des}}
                        </el-col>
        ...
        >
            <add-emergency-team :type="'add'" :companyInfo=companyInfo :detailInfo="detailInfo" v-on:toggleHidden="toggleHidden" ></add-emergency-team>
        </el-dialog>
        <!--新增的dialog-->
        <el-dialog title="编辑" :visible.sync="editShow" v-if="editShow"  width="950px"
                   :close-on-click-modal="false" append-to-body @close="closeDialog">
            <add-emergency-team :type="'edit'" :companyInfo=companyInfo :detailInfo="detailInfo" v-on:toggleHidden="toggleHidden"></add-emergency-team>
            <!--<edit-emergency-team :type="'edit'" :companyInfo=companyInfo ></edit-emergency-team>-->
        </el-dialog>
...
<script>
    ...
    import AddEmergencyTeam from './components/add-emergency-team.vue'
//    import EditEmergencyTeam from './components/edit-emergency-team.vue'
    import elDragDialog from '@/directive/el-drag-dialog'

    import {fetchAreaTree} from '@/api/courseMonitor/alarmSynthesis';
    import {emergencyTroopsPage,delEmergency,emergencyTroopsSaveOrUpdateBounds} from '@/api/emergencyManagement/emergencyResource'
    ...
    export default {
        ...
        components: {Pagination, CommonSubtitle, googleMapView,AddEmergencyTeam,elDragDialog,ToggleGoogleMap},
...
//                this.addRouteLine();
            ...
            getList(){
                ...
                emergencyTroopsPage(obj).then(res => {
            ...
            delEmergency() {
                ...
                this.$confirm('此操作将删除该应急队伍, 是否继续?', '提示', {
                    ...
                    delEmergency({id:this.detailInfo.hasOwnProperty('id') ? this.detailInfo.id : null}).then(res => {
                        self.$message({
                            showClose: true,
                            message: '删除成功！',
                            type: 'success'
...
//                    this.$message({message: '暂未标注，请先标注位置信息！', type: 'warning'})
            ...
            saveOrUpdateBounds(params) {
                emergencyTroopsSaveOrUpdateBounds(params).then(res => {
                    this.$message({
                        showClose: true,
                        message: '保存成功！',
                        type: 'success'
