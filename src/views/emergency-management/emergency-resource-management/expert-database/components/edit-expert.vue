...
<script>
    ...
    import {saveServiceExpert,getServiceExpert} from '@/api/emergency'
        ...
        methods: {
            ...
            getExpertDetail(){
                getServiceExpert({id:this.expertId}).then(res=>{
                    if(res.code == 1000){
                        res.data.major = res.data.major + '';
                        res.data.sex = res.data.sex + '';
                        this.ruleForm = res.data;
                        if(res.data.experienceList.length == 0){
                        ...
                        this.experienceList = res.data.experienceList;
                    }
                })
            },
            //条件检索 - 增加一行
