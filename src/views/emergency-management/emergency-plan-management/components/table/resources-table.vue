<template>
    <div class="container">
        <CommonSubtitle title="选择资源" :isBold="true" v-if="!handleEdit"
                        style="width: 100%;line-height: 20px;margin-bottom: 10px"></CommonSubtitle>
        <!-- 表格开始 -->
        <el-table
...
//            console.log('type', this.type);
        ...
        methods: {
            ...
            handleClearSelection() {
                this.$refs['resourcesTable'].clearSelection()
            }
        }
    }
</script>
