    ...
    <div class="app-container">
        <el-container>
            <el-aside width="350px" class="search-tree all-background" style="overflow: hidden;">
                <CommonSubtitle title="应急演习列表" :isBold="true"
            ...
            <el-main style="padding: 20px 20px 0 20px">
                    ...
                    <el-form :inline="true" :model="form" ref="form" class="form-inline-search" label-width="120px">
                        <el-row :gutter="20">
                            <el-col :span="this.isSmallBtn ? 12 : 8">
                                <el-form-item label="演习名称：" class="form-inline-search-item" >
                                    <el-input v-model="form.name" placeholder="请输入演习名称"></el-input>
                                </el-form-item>
                            </el-col>
                ...
                <el-card class="table-card">
                    <div style="margin-bottom: 10px">
                        <el-button type="primary" icon="el-icon-document-add" @click="addExerciseFlag=true">新增</el-button>
                    ...
                    >
                        ...
                        <el-table-column label="演习名称" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.name}}</template>
                        </el-table-column>
                        <el-table-column label="企业名称" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.sideCode}}</template>
                        </el-table-column>
                        <el-table-column label="演习地点" header-align="center" align="center">
                        ...
                        <el-table-column label="参演机构" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.endTime}}</template>
                        </el-table-column>
                        <el-table-column label="参演机构" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.endTime}}</template>
                        ...
                        >
                            <template slot-scope="{row}">
                                <i class="icon iconfont iconchakan" title="查看" @click="detailExerciseFlag=true"></i>
        ...
        <!--新增的dialog-->
        <el-dialog title="新增" :visible.sync="addExerciseFlag"  width="50%" :close-on-click-modal="false" v-elDragDialog append-to-body>
            <add-exercise></add-exercise>
        </el-dialog>
        <!--编辑的dialog-->
        <el-dialog title="编辑" :visible.sync="editExerciseFlag"  width="50%" :close-on-click-modal="false" v-elDragDialog append-to-body>
            <edit-exercise :materialsInfo="materialsInfo"></edit-exercise>
        </el-dialog>
        <!--编辑的dialog-->
        <el-dialog title="详情" v-if="detailExerciseFlag" :visible.sync="detailExerciseFlag"  width="50%" :close-on-click-modal="false" v-elDragDialog append-to-body>
...
<script>
    ...
    export default {
        ...
        components: {SeeDetail, AddExercise, Pagination, CommonSubtitle,EditExercise},
        ...
        data() {
            return {
                ...
                editExerciseFlag:false,
                detailExerciseFlag:false,
            }
        },
        watch: {
