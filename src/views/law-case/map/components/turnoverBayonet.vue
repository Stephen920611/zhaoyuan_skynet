...
<template>
    <div class="tab-container">
        <div class="search-wrap">
            ...
            <el-row>
                <el-col :span="14" class="search-item">
                    <el-input v-model="form.name" placeholder="请输入卡口名称" @keyup.enter.native="handleSearch"></el-input>
                </el-col>
        ...
        <pagination
                ...
                class="pagination"
                @pagination="bayonetList"
        />
    </div>
</template>
<script>
    import {queryBayonetPoints} from '@/api/map'
    ...
    export default {
        ...
        methods: {
            bayonetList() {
                ...
                queryBayonetPoints(obj).then(res => {
            ...
            handleSelect(index,data) {
                ...
                if(data.lat && data.lng){
                    ...
                    //定位--弹出气泡窗口
                    this.locMarkerOpenInfoWindow(data.id,'bayonet',true);
                }else{
