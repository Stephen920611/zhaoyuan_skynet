            ...
            <el-main style="padding: 20px 20px;">
                            ...
                            <el-col :span="this.isSmallBtn ? 6 : 10">
                                <el-form-item label="当前环节：" class="form-inline-search-item"
                                    ...
                                    <el-radio-group v-model="form.currentLink">
                                        ...
                                        <el-radio label="1" border size="medium">待复核</el-radio>
                ...
                <el-card>
                    ...
                    >
                        ...
                        <el-table-column label="初评等级" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.endTime}}</template>
                        </el-table-column>
                        <el-table-column label="复核等级" header-align="center" align="center">
                            <template slot-scope="{row}">{{row.endTime}}</template>
                        </el-table-column>
            ...
            dealDiffPage(item,type){
                ...
                switch (item.name){
                    case '烟台市危险货物运输企业质量信誉考核评分表':
                        this.$router.push({name: 'EALevelCheckCheckScale'});
                        break;
                    case '质量信誉等级评定申请表':
                        this.$router.push({name: 'EALevelCheckApplicationForm'});
                        break;
                    case '烟台市危货企业质量信誉等级评定表':
                        this.$router.push({name: 'EALevelCheckRatingForm'});
                        break;
                }
            },
        }
