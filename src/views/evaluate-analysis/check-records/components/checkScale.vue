            ...
            <el-main style="padding: 0 10px 10px;">
                ...
                <el-main style="padding: 10px 0;">
                    ...
                    >
                        ...
                        <el-table-column label="评价建议" header-align="center" align="center" min-width="14%"
                                         v-if="this.clickId !== 1">
                            <template slot-scope="{row}" >
                                <el-popover
                                        placement="left"
                                >
                                    <div><i class="el-icon-info" style="color:rgb(255, 153, 0);margin-right: 3px"></i>{{row.adviceRate}}</div>
                                    <i slot="reference" class="icon iconfont iconchakan" style="cursor: pointer" title="查看1" @click="showDetail(row)"></i>
                                </el-popover>
