<template>
    <div>
        <div class="container fa-border">
            <!--编辑时，数据表中已存在的数据展示-->
            <el-row class="qualify-item margin-d-10" v-for="(item,index) in driverData" :key="index">
                <el-col :span="23" class="padding-t-10">
                    <driver-license-form :ref="'form_'+index" :isDisabled="isDisabled" :workerId="workerId" :workerName="workerName" :driverData="item" role="edit"></driver-license-form>
                </el-col>
            ...
            <el-row class="qualify-item margin-d-10" v-for="(item,index) in qualifys" :key="'info_'+index">
                <el-col :span="23" class="padding-t-10">
                    <driver-license-form :ref="'form_'+index" :isDisabled="isDisabled" :workerId="workerId" :workerName="workerName" :driverData="item" role="add"></driver-license-form>
                </el-col>
                <el-col :span="1" class="margin-t-15 padding-lr-20">
