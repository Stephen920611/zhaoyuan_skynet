        ...
        <div class="container fa-border">
            <el-row class="qualify-item margin-d-10" v-for="(item,index) in qualifys" :key="index">
                <el-col :span="isDisabled?24:23" class="fa-border padding-t-10">
                    <escort-certificate-form :ref="'form_'+index" :isDisabled="isDisabled" :workerId="CurrentWorkerId" :workerName="CurrentWorkerName"></escort-certificate-form>
                </el-col>
...
<script>
    ...
    export default {
        ...
        components: {EscortCertificateForm},
        data() {
            return {
                qualifys:[{}],
