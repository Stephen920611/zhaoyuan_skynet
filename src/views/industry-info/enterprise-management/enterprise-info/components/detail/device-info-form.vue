    ...
    <div class="form-container">
        <el-form label-position="right" ref="ruleForm" :inline="true" label-width="120px" :model="ruleForm"
            ...
            <el-form-item label="摄像机编码:" prop="cameraCode">
                <el-input v-model="ruleForm.cameraCode" disabled></el-input>
            </el-form-item>
            <el-form-item label="摄像机类型:" prop="cameraType">
                <el-select v-model="ruleForm.cameraType" placeholder="请选择" disabled>
                    <el-option
            ...
            <el-form-item label="摄像机位置:" prop="positionType">
                <el-select v-model="ruleForm.positionType" placeholder="请选择" disabled>
                    <el-option
