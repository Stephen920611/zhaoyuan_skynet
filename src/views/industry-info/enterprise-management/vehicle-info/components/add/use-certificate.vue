        ...
        <div class="container">
            <el-row class="qualify-item margin-d-10" v-for="(item,index) in qualifys" :key="index">
                <el-col :span="isDisabled?24:23" class="fa-border padding-t-10">
                    <use-certificate-form :ref="'form_'+index" :isDisabled="isDisabled"
                                          :carInfo="carInfo"></use-certificate-form>
                </el-col>
                <el-col :span="1" class="margin-t-15 padding-lr-20" v-show="!isDisabled">
                    <el-button type="primary" icon="el-icon-plus" title="添加" size="small" circle @click="addQualify"
                               v-if="index==0"></el-button>
                    <el-button type="danger" icon="el-icon-close" title="删除" size="small" circle
                               @click="delQualify(index)" v-if="index>0"></el-button>
                </el-col>
            </el-row>
            <!--<el-row>
