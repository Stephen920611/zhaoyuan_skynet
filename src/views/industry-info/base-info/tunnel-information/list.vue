<template>
    <div class="map-container">
        ...
        <!--新增的dialog-->
        <el-dialog title="新增" :visible.sync="addShow"  width="500px" :close-on-click-modal="true" append-to-body>
...
<script>
    ...
    export default {
        ...
        components: { googleMapView, switchItem, dropDown,CommonSubtitle,AddTunnel},
        created() {
            this.getList();
