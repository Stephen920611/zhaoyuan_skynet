    ...
    <div class="app-container">
            ...
            <el-main style="padding: 0;">
                ...
                <div class="right-panel all-background">
                    ...
                    >
                        ...
                        <el-table-column label="所属公司" header-align="center" align="center" min-width="100">
                            <template slot-scope="{row}">{{row.companyName}}</template>
                        </el-table-column>
                        <el-table-column label="准驾车型" header-align="center" align="center" min-width="50">
                            <template slot-scope="{row}">{{row.allowTypeName}}</template>
                        </el-table-column>
                        <el-table-column label="初次领证时间" header-align="center" align="center" min-width="80">
                            <template slot-scope="{row}">{{row.givingTime}}</template>
                        </el-table-column>
                        <el-table-column label="驾驶证号" header-align="center" align="center" min-width="60">
                            <template slot-scope="{row}">{{row.licenceCode}}</template>
                        </el-table-column>
                        <el-table-column label="证件有效期" header-align="center" align="center" min-width="100">
        ...
        <el-dialog title="查看" :visible.sync="dialogVisible" v-elDragDialog width="40%" :close-on-click-modal="false">
            ...
            <el-row class="row-margin">
                ...
                <el-col :span="7" style="margin-right: 50px"><el-input v-model="currentRow.workerName" :disabled="true"></el-input></el-col>
                <el-col :span="4"><label class="grid-content">所属公司：</label></el-col>
                <el-col :span="7" ><el-input v-model="currentRow.companyName" :disabled="true"></el-input></el-col>
            </el-row>
            <el-row class="row-margin">
                <el-col :span="3"><label class="grid-content">准驾车型：</label></el-col>
                <el-col :span="7" style="margin-right: 50px"><el-input v-model="currentRow.allowTypeName" :disabled="true"></el-input></el-col>
                <el-col :span="4"><label class="grid-content">初次领证时间：</label></el-col>
                <el-col :span="7" ><el-input v-model="currentRow.givingTime" :disabled="true"></el-input></el-col>
            </el-row>
            <el-row class="row-margin">
                <el-col :span="3"><label class="grid-content">驾驶证号：</label></el-col>
                <el-col :span="7" style="margin-right: 50px"><el-input v-model="currentRow.licenceCode" :disabled="true"></el-input></el-col>
                <el-col :span="4"><label class="grid-content">证件有效期：</label></el-col>
                <el-col :span="7" ><el-input v-model="currentRow.endUseTime" :disabled="true"></el-input></el-col>
            </el-row>
            <el-row class="row-margin">
                <el-col :span="3"><label class="grid-content">状态：</label></el-col>
                <el-col :span="7" style="margin-right: 50px"><el-input v-model="currentRow.statusName" :disabled="true"></el-input></el-col>
                <el-col :span="4"><label class="grid-content">备案日期：</label></el-col>
                <el-col :span="7" ><el-input v-model="currentRow.recordTime" :disabled="true"></el-input></el-col>
            </el-row>
...
<script>
    ...
    import {workerDriveLicense} from '@/api/industry'
