...
//                    driverId:null, //驾驶员id
        ...
        methods: {
            ...
            fillInFormByUser(){
                ...
                getBasicCompanyList({companyId:this.companyId}).then(res=>{
                    if(res.data.list[0]){
                ...
                //获取承运企业下的所属拖车车辆
                getFreeCar({companyId:this.companyId,carType:'1,2'}).then(res=>{
                    this.carNoArray = [];
                    res.data.map(item=>{
                ...
                //获取承运企业下的所属挂车车辆
                getFreeCar({companyId:this.companyId,carType:'3'}).then(res=>{
                    this.trailerNoArray = [];
                    res.data.map(item=>{
                ...
                //获取押运员列表
                getFreeWorker({companyId:this.companyId,type:'2'}).then(res=>{
                    this.escortArray = [];
                ...
                //获取驾驶员列表
                getFreeWorker({companyId:this.companyId,type:'1'}).then(res=>{
                    this.driverArray = [];
                    res.data.list.map(item=>{
