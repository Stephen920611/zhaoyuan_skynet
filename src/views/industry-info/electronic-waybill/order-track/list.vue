            ...
            <el-main style="padding: 10px;">
                <div class="text item">
                    <div class="filter-container">
                        <el-row>
                            <el-col :span="this.isSmallBtn ? 4 : 3">
                                <el-input
                                        v-model="form.name"
                                        placeholder="请输入申报单号"
                                        class="filter-item"
                    ...
                    >
                        ...
                        <el-table-column label="运输公司名称" header-align="center" align="center"  min-width="80">
                        ...
                        <el-table-column label="货物名称" header-align="center" align="center"  min-width="50">
                            <template slot-scope="{row}">{{row.a6}}</template>
                        </el-table-column>
                        <el-table-column label="目的地" header-align="center" align="center"  min-width="80">
                            <template slot-scope="{row}">{{row.a7}}</template>
                        </el-table-column>
                        <el-table-column label="风险等级" header-align="center" align="center"  min-width="30">
                            <template slot-scope="{row}">{{row.a8}}</template>
                        </el-table-column>
                        <el-table-column label="状态" header-align="center" align="center"  min-width="30">
                            <template slot-scope="{row}">{{row.a9}}</template>
                        </el-table-column>
                        <!-- 操作 -->
                        <el-table-column
                                label="操作"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                list: [
                    {a1:'BSQ2016021562787',a2:'龙口市恒生液化气有限公司',a3:'鲁F12RD6',a4:'李晨明',a5:'32102522532233555',a6:'1-丙醇',a7:'龙口市新城大街14泊位',a8:'中',a9:'下单'},
                    {a1:'BSQ2016021562787',a2:'龙口市恒生液化气有限公司',a3:'鲁F12RD6',a4:'李晨明',a5:'32102522532233555',a6:'1-丙醇',a7:'龙口市新城大街14泊位',a8:'中',a9:'下单'},
                    {a1:'BSQ2016021562787',a2:'龙口市恒生液化气有限公司',a3:'鲁F12RD6',a4:'李晨明',a5:'32102522532233555',a6:'1-丙醇',a7:'龙口市新城大街14泊位',a8:'中',a9:'下单'},
                    {a1:'BSQ2016021562787',a2:'龙口市恒生液化气有限公司',a3:'鲁F12RD6',a4:'李晨明',a5:'32102522532233555',a6:'1-丙醇',a7:'龙口市新城大街14泊位',a8:'中',a9:'下单'},
                    {a1:'BSQ2016021562787',a2:'龙口市恒生液化气有限公司',a3:'鲁F12RD6',a4:'李晨明',a5:'32102522532233555',a6:'1-丙醇',a7:'龙口市新城大街14泊位',a8:'中',a9:'下单'},
