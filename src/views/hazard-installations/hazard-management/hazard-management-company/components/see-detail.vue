<template>
    <div class="mask-add-edit-manage" id="mask" style="position: relative;max-height: calc(100vh - 300px)" v-scrollBar>
        <div class="mask-content" id="mask-content">
            <div class="info-wrap">
                <el-form label-position="right" ref="ruleForm" :rules="rules" :model="form" :inline="true" label-width="185px">
                    ...
                    <el-form-item label="危险源R值:" prop="rvalue">
                        <el-input v-model="form.rvalue" type="number" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="港口危险货物名称:" prop="hazard">
                        <el-input v-model="form.hazard" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="生产用途:" prop="purpose">
                        <el-select v-model="form.purpose" class="filter-item"
                                   placeholder="请选择生产用途" disabled>
                            <el-option
                    ...
                    <el-form-item label="与防护目标最近距离(米):">
                        <el-input v-model="form.distance" type="number" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="500m范围内人数估值:">
                        <el-input v-model="form.peopleNum" type="number" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="近三年内港口危险货物事故:">
                        <el-input v-model="form.accidentSituation" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="危险性类别:">
                        <el-input v-model="form.type" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="联合国编号:">
                        <el-input v-model="form.unCode" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="生产工艺:">
                        <el-input v-model="form.technology" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="危险源影响范围半径（米）:">
                        <el-input v-model="form.radius"  type="number" disabled></el-input>
                    </el-form-item>
                </el-form>
            </div>
