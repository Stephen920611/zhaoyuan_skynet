...
<script>
    ...
    import {basicArea,getByCode} from '@/api/industry'
    ...
    export default {
        ...
        components: {SeeDetail, googleMapView, dropDown,CommonSubtitle,Pagination,switchItem,regionTree},
        data() {
            return {
                map: null,
