            ...
            <div class="info-wrap">
                <el-form label-position="right" ref="ruleForm" :rules="rules" :model="form" :inline="true" label-width="170px">
                    ...
                    <el-form-item label="所属罐组:" prop="tankGroup">
                        <el-input v-model="form.tankGroup" disabled></el-input>
                    </el-form-item>
                    <!-------------------------基础信息----------------------------------->
                    ...
                    <el-form-item label="危险货物作业附证编号:" prop="certificate">
                        <el-input v-model="form.certificate" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="使用登记证编号:" prop="useCertificate">
                        <el-input v-model="form.useCertificate" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="设计储存介质类别:" prop="designMedium">
                        <el-input v-model="form.designMedium" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="许可储存介质:" prop="allowMedium">
                        <el-input v-model="form.allowMedium" disabled></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="作业危险货物品名:" prop="workCargoType">
                        <el-input v-model="form.workCargoType" disabled></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="设计使用年限(年):" prop="designLife">
                        <el-input v-model="form.designLife" @keydown.native="upNumber" @keyup.native="upNumber" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="材料分类:" prop="material">
                        <el-select v-model="form.material" class="filter-item"
                                   placeholder="请选择材料分类" disabled>
                            <el-option
                    ...
                    <el-form-item label="几何形式分类:" prop="geometry">
                        <el-select v-model="form.geometry" class="filter-item"
                                   placeholder="请选择几何形式分类" disabled>
                            <el-option
                    ...
                    <el-form-item label="最大容积(立方米):" prop="volume">
                        <el-input v-model="form.volume" @keydown.native="upNumber" @keyup.native="upNumber" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="罐体公称直径(米):" prop="diameter">
                        <el-input v-model="form.diameter" @keydown.native="upDecimals" @keyup.native="upDecimals" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="设计最大承压(兆帕):" prop="designPressure">
                        <el-input v-model="form.designPressure" @keydown.native="upDecimals" @keyup.native="upDecimals" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="当前工作压力(兆帕):" prop="workPressure">
                        <el-input v-model="form.workPressure" @keydown.native="upDecimals" @keyup.native="upDecimals" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="设计最大承温(℃):" prop="designTemperature">
                        <el-input v-model="form.designTemperature" @keydown.native="upNumber" @keyup.native="upNumber" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="实际最高温度(℃):" prop="maxTemperature">
                        <el-input v-model="form.maxTemperature" @keydown.native="upNumber" @keyup.native="upNumber" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="设计最高液位(米):" prop="designLevel">
                        <el-input v-model="form.designLevel" @keydown.native="upDecimals" @keyup.native="upDecimals" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="最高试验液位(米):" prop="maxLevel">
                        <el-input v-model="form.maxLevel" @keydown.native="upDecimals" @keyup.native="upDecimals" disabled></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="检测周期(月):" prop="checkCycle">
                        <el-input v-model="form.checkCycle" @keydown.native="upNumber" @keyup.native="upNumber" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="安装形式分类:" prop="installType">
                        <el-select v-model="form.installType" class="filter-item"
                                   placeholder="请选择安装形式分类" disabled>
                            <el-option
                    ...
                    <el-form-item label="设计单位名称:" prop="designCompany">
                        <el-input v-model="form.designCompany" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="设计单位资质:" prop="designQualify">
                        <el-input v-model="form.designQualify" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="制造单位名称:" prop="makeCompany">
                        <el-input v-model="form.makeCompany" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="制造单位资质:" prop="makeQualify">
                        <el-input v-model="form.makeQualify" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="安装单位名称:" prop="installCompany">
                        <el-input v-model="form.installCompany" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="安装单位资质:" prop="installQualify">
                        <el-input v-model="form.installQualify" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="检测单位名称:" prop="checkCompany">
                        <el-input v-model="form.checkCompany" disabled></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="检测单位资质:" prop="checkQualify">
                        <el-input v-model="form.checkQualify" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="维护情况:" prop="maintain">
                        <el-input v-model="form.maintain" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="其它说明:" prop="mark">
                        <el-input v-model="form.mark" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="工作液位(M):" prop="workHeight">
                        <el-input v-model="form.workHeight" @keydown.native="upDecimals" @keyup.native="upDecimals" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="工作温度(°C):" prop="workTemperate">
                        <el-input v-model="form.workTemperate" @keydown.native="upDecimals" @keyup.native="upDecimals" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="理化信息:" prop="chemicalInfo">
                        <el-input v-model="form.chemicalInfo" disabled></el-input>
                    </el-form-item>
