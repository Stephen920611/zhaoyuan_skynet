<template>
    <div class="app-container">
        ...
        <!--新增的dialog-->
        <el-dialog title="新增电子运单" v-if="addWaybillShow" :visible.sync="addWaybillShow"  width="1200px" :close-on-click-modal="false" append-to-body v-elDragDialog @open="openAddWayBillDialog" @close="closeAddWayBillDialog">
