                ...
                <div class="add-form">
                    <el-form label-position="right" :rules="rules" ref="ruleForm" :inline="true" label-width="185px" :model="ruleForm">
                        <el-form-item label="货物名称:" prop="goodsName" class="long-item">
                            <el-input v-model="ruleForm.goodsName" placeholder="请输入货物名称" :disabled="isDisabled"></el-input>
                        </el-form-item>
                        <el-form-item label="危险货物品名:" prop="companyName">
                            <el-input v-if="role=='edit'" v-model="ruleForm.name" placeholder="请选择危险货物品名" clearable @focus="showChemicalTable=true" @change="clearFunc" :disabled="isDisabled">
                                <el-button slot="append" icon="el-icon-search" @click="showChemicalTable=true"></el-button>
                            </el-input>
                            <el-input v-else v-model="ruleForm.name" placeholder="请选择危险货物品名" clearable @focus="showChemicalTable=true" @change="clearFunc" :disabled="isDisabled">
                            </el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="单位:" prop="unit">
                            <el-select v-model="ruleForm.unit" clearable placeholder="请选择单位" style="width: 100%" :disabled="isDisabled">
                                <el-option
                        ...
                        <el-form-item label="每单位重量（吨）:" prop="unitWeight">
                            <el-input v-model="ruleForm.unitWeight" placeholder="请输入重量" type="number" :disabled="isDisabled"></el-input>
                        </el-form-item>
                        <el-form-item label="包装规格:" prop="packageInfo">
                            <el-input v-model="ruleForm.packageInfo" placeholder="请输入包装规格" :disabled="isDisabled"></el-input>
                        </el-form-item>
                        <el-form-item class="margin-td-10" style="text-align: center; width: 100%;"  v-show="role=='edit'">
    ...
    export default {
          ...
          'data':{
              handler(value){
                  if(value){
                      ...
                      this.ruleForm.name = value.chemicalName;
                      this.ruleForm.unit = value.unit + '';
                  }
              },
              immediate: true,
              deep: true
        ...
        methods: {
            ...
            showHiddenSearch: function (flag, data) {
                ...
                for(let key of keys){
                    if(Object.keys(this.ruleForm).indexOf(key)>-1 && key != 'id'){
