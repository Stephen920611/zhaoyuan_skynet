            ...
            <div class="info-wrap">
                ...
                <div class="add-form">
                    ...
                    >
                        ...
                        <el-form-item class="other-form-item two-label" prop="maxFilling">
                            <span slot="label">
                        ...
                        <el-form-item class="margin-td-10" style="text-align:end; width: 100%;">
                            ...
                            <el-button type='primary' @click="checkRules">保 存</el-button>
                        </el-form-item>
                    </el-form>
                </div>
                <div class="add-img">
...
<script>
    ...
    import {getByCode, basicChemicalsList, carSaveOrUpdate, fetchCompanyCarInfo} from '@/api/industryInfo/vehicleInfo'
