<template>
    <div class="mask-add-edit-manage" id="mask" style="position: relative;height: 100%" v-scrollBar>
        ...
        methods: {
            updateData(data){
                if(data && JSON.stringify(data) != "{}"){
                    ...
                    data.companyChemicalList.map(item=>{
                        this.ruleForm.chemicalId.push(item.chemicalId+'')
                    });
                    data.companyTypeList.map(item=>{
            ...
            getQualifyInfo(){
                ...
                companyQuality({companyId:this.companyId}).then(res=>{
                    if(res.code == '1000'){
            ...
            getDetailInfo(){
                this.deviceInfoData=[];
                getCompanyDetailCamInfo({companyId:this.companyId}).then(res=>{
                    if(res.code == '1000'){
