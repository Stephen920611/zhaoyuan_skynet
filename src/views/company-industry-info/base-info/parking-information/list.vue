<template>
    <div class="map-container">
        ...
        <el-dialog title="编辑" :visible.sync="editShow"  width="500px" :close-on-click-modal="false" v-elDragDialog append-to-body>
            <edit-parking v-on:showHiddenEdit="showHiddenEdit" :parkingData="list[selectedItemIndex]"></edit-parking>
        </el-dialog>
    </div>
</template>
<script>
    ...
    import EditParking from './components/edit-parking.vue'
    export default {
        ...
        components: { googleMapView, switchItem, dropDown,CommonSubtitle,addParking,EditParking},
        created() {
            this.getList();
