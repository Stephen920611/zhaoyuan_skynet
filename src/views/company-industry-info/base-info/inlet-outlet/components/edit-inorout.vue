        ...
        <div class="mask-content" id="mask-content">
            <div class="info-wrap">
                <el-form label-position="right" :rules="rules" ref="ruleForm" label-width="125px" :model="ruleForm">
                    ...
                    <el-form-item label="进出口道名称:" prop="name">
...
<script>
    ...
    import {basicBayonet,getByCode} from '@/api/industry'
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    name: [
                        { required: true, message: '请输入进出口道名称', trigger: 'blur' }
                    ],
                    areaId: [
        ...
        created(){
            ...
            for(let key of keys){
                this.ruleForm[key] = this.inOutdata[key];
            }
        ...
        methods: {
            ...
            dictionary() {
                //进出卡口类型
                getByCode({code: 'COMPANY_BAYONET_TYPE', enable: 1}).then(res => {
                    this.typeOptions = [];
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        basicBayonet(this.ruleForm).then(res => {
                            this.$message({
                                showClose: true,
                                message: '编辑成功！',
                                type: 'success'
