const emapExtension = {};
const _this = emapExtension;
_this.getMarkerLabel =  function(gMapsApi) {
  ...
  var MarkerLabel_ = function(marker, crossURL, handCursorURL) {
    this.marker_ = marker;
  ...
  MarkerLabel_.prototype.onAdd = function () {
    ...
    MarkerLabel_.prototype.setVisible = function (flag) {
      ...
      if(flag){
              this.labelDiv_.style.display = "block";
    }
      this.eventDiv_.style.display = this.labelDiv_.style.display;
    };

    var MarkerWithLabel = function(opt_options) {
